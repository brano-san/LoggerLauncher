...
// clang-format off
#define LOG(level, name, message, ...)                      CAT_LOG_##level(LOGGER_NAME, LOGGER_CATEGORIES_SOURCES, name, message, ##__VA_ARGS__)
#define LOGV(level, name, message, ...)                     CAT_LOGV_##level(LOGGER_NAME, LOGGER_CATEGORIES_SOURCES, name, message, ##__VA_ARGS__)
#define LOG_LIMIT_TIME(level, name, time, message, ...)     CAT_LOG_##level##_LIMIT_TIME(LOGGER_NAME, LOGGER_CATEGORIES_SOURCES, name, time, message, ##__VA_ARGS__)
#define LOG_LIMIT_EVERY_N(level, name, count, message, ...) CAT_LOG_##level##_LIMIT_EVERY_N(LOGGER_NAME, LOGGER_CATEGORIES_SOURCES, name, count, message, ##__VA_ARGS__)
