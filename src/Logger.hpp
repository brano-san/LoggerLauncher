...
#define LOG_NOTICE(name, message, ...)    CAT_LOG_NOTICE(LOGGER_NAME, LOGGER_CATEGORIES_SOURCES, name, message, ##__VA_ARGS__)
...
#define LOGV_NOTICE(name, message, ...)    CAT_LOGV_NOTICE(LOGGER_NAME, LOGGER_CATEGORIES_SOURCES, name, message, ##__VA_ARGS__)
...
#define LOG_INFO_NOTICE_TIME(name, time, message, ...)    CAT_LOG_NOTICE_LIMIT_TIME(LOGGER_NAME, LOGGER_CATEGORIES_SOURCES, name, time, message, ##__VA_ARGS__)
...
#define LOG_NOTICE_LIMIT_EVERY_N(name, count, message, ...)   CAT_LOG_NOTICE_LIMIT_EVERY_N(LOGGER_NAME, LOGGER_CATEGORIES_SOURCES, name, count, message, ##__VA_ARGS__)
